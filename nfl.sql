...
SELECT name, head_coach FROM teams WHERE conference = 'NFC' AND division = 'South' OR conference = 'AFC' AND division = 'East';
...
SELECT name, position FROM players ORDER BY salary ASC;
